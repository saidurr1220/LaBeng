...
<div class="lab-hero">
    ...
    <div class="lab-hero__cta-wrap">
        ...
        <a href="<?php echo esc_url( home_url( '/find-near-me/' ) ); ?>" class="lab-hero__nearby-link">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
