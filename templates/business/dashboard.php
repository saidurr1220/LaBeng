...
$nav_items = array(
    ...
    'booking-steps'=> array( 'label' => 'Booking Steps', 'icon' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 14h6"/><path d="M9 10h6"/><path d="M9 18h6"/></svg>' ),
...
<div class="lab-dashboard" id="lab-business-dashboard" data-business-id="<?php echo esc_attr( $business_id ); ?>">
    ...
    <main class="lab-main">
        ...
        <div class="lab-tab-content" id="lab-tab-booking-steps" style="display:none;"><?php include LABENG_PATH . 'templates/business/tab-booking-steps.php'; ?></div>
